...
*/
let frase2 = "I have 4 dogs";
function onlyLetters(frase2) {
    console.log(frase2.replace(/\d+/g, ''));
}
onlyLetters(frase2);
...
function isThisAnEmail(email, regexEmail) {
    if (email == regexEmail) {
        console.log(true);
    } else {
...
isThisAnEmail(email, regexEmail);
...
*/
let mioGiorno = new Date();
mioGiorno.setDate(9);
let mioMese = new Date();
mioMese.setMonth(11);
console.log(mioMese + mioGiorno);
function isTodayMyBirthday() {
  if (mioGiorno == 18 && mioMese == 11) {
...
/* function onlyInLastMillennium(movies) {
    ...
    if (mezzoYear < 20) {
        ...
        console.log('Il film è stato prodotto dopo il 2000');
    }
}
...
function aggiungiElemento() {
  ...
  elementoLista.innerText = "Aggiungere un nuovo elemento alla lista";
...
*/
function aggiungoClasse(tagName, className) {
  let elementiCss = document.getElementsByTagName(tagName)
  for (let i = 0; i < elementiCss.length; i++) {
    elementiCss[i].classList.add(className);
  }
}

aggiungoClasse('tr', 'test');
